...
public class ChooserSetting{
    ...
    /**图片加载的占位图片*/
    public static int placeResId = R.drawable.image_chooser_placeholder;
    ...
    /**照片选择指示器*/
    public static IChooseDrawable chooseDrawable = new CircleChooseDrawable(true,0xFF303F9F);
